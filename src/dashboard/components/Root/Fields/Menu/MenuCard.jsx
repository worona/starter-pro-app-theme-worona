...
const formSelector = formValueSelector('StarterProThemeForm', st => st.theme.reduxForm);
const syncErrorsSelector = getFormSyncErrors('StarterProThemeForm', st => st.theme.reduxForm);
